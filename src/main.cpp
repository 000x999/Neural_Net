...
int main() {
    ...
    std::ofstream ofs("C:\\C_DEV\\AI_LLM\\NeuralNetwork\\NeuralNetwork\\src\\TrainingData\\Outs.txt", std::ofstream::out);
    ofs.close();
    // Redirect stdout to Outs.txt
    std::ofstream out("C:\\C_DEV\\AI_LLM\\NeuralNetwork\\NeuralNetwork\\src\\TrainingData\\Outs.txt");
    ...
    try{
	TrainingData data("C:\\C_DEV\\AI_LLM\\NeuralNetwork\\NeuralNetwork\\src\\TrainingData\\DataFile.txt"); 
